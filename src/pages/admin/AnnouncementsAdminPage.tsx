...
export function AnnouncementsAdminPage() {
  return (
    <>
      ...
      <Card variant="outlined" sx={{ mb: 3 }}><CardContent><Typography variant="h6">Security boundary</Typography><Typography sx={{
        color: "text.secondary"
      }}>Frontend controls improve UX, but backend authorization must decide who is actually allowed to publish announcements.</Typography></CardContent></Card>
      <AnnouncementsPage />
    </>
  );
}
